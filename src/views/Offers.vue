  ...
  <section class="mx-auto max-w-[1440px] px-6">
    <nav aria-label="Breadcrumb" class="">
      <ol role="list" class="mb-4 flex max-w-2xl items-center space-x-2 lg:max-w-7xl">
        ...
        <li>
          <div class="flex items-center">
            <div class="mr-2 text-sm font-medium text-gray-900">Ofertas del día</div>
          </div>
        </li>
      </ol>
    </nav>
    <p class="mt-6 text-2xl font-bold" v-text="'OFERTA DE ROPA, ZAPATOS Y ACCESORIOS: HASTA UN 40 % DE DESCUENTO'" />
    <p
