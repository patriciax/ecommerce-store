      ...
      <section class="grid gap-x-4 gap-y-1">
        <section class="grid gap-3 border-b pb-2">
          <div class="flex flex-col text-lg font-bold">
            ...
            <p class="lowercase text-gray-500">{{ storePaymentMethods.invoice.carrier.address }}</p>
          </div>
          <div class="flex flex-col text-lg font-bold">
            Fecha del pedido
            <p class="lowercase text-gray-500">{{ storePaymentMethods.invoice.created }}</p>
          </div>

          <div class="flex flex-col text-lg font-bold">
            Número de pedido
            <p class="lowercase text-gray-500">{{ storePaymentMethods.invoice.transactionOrder }}</p>
          </div>
        </section>
