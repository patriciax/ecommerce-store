...
const colorBtn = {
  ...
  primary:
    'bg-gray-800 text-white font-bold p-4 rounded-xl text-sm font-semibold leading-6 shadow-sm   hover:bg-opacity-90 flex gap-1 item-center justify-center group relative mx-auto',
  secondary:
